...
{
    public class ShowBizContext : DbContext
    {
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            //base.OnConfiguring(optionsBuilder);
            var cwd = Environment.CurrentDirectory;
            var dbPath = Path.GetFullPath("showbiz.db");
            optionsBuilder.UseSqlite($"Data Source=\"{dbPath}\"");
        }

        public DbSet<Production> Productions { get; set; }   // Movie or Series
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            var movies = new Movie[]
            {
                new Movie
                {
                    ...
                    Duration = TimeSpan.FromMinutes(181), Release = new DateTime(2019, 4, 26)
                },
                new Movie
                {
                    Id = 2, Name = "The Lion King", Duration =TimeSpan.FromMinutes(118),
                    Release = new DateTime(2019, 7, 19)
                },
                new Movie
                {
                    Id = 3, Name = "Ip Man 4", Duration = TimeSpan.FromMinutes(105),
                    Release = new DateTime(2019, 12, 25)
                },
                new Movie
                {
                    Id = 4, Name = "Gemini Man", Duration = TimeSpan.FromMinutes(116),
                    Release = new DateTime(2019, 11, 20)
                },
                new Movie
                {
                    Id = 5, Name = "Downton Abbey", Duration = TimeSpan.FromMinutes(120),
                    Release = new DateTime(2020, 9, 20)
                }
            };
            var series = new Series[]
            {
                new Series
                {
                    Id = 6, Name = "The Fresh Prince of Bel-Air", EpisodeCounts = 148,
                    Release = new DateTime(1990, 9, 10)
                },
                new Series
                {
                    Id = 7, Name = "Downton Abbey", EpisodeCounts = 52, Release = new DateTime(2010, 09, 26)
                },
                new Series
                {
                    Id = 8, Name = "Stranger Things", EpisodeCounts = 34, Release = new DateTime(2016, 7, 11)
                },
                new Series
                {
                    Id = 9, Name = "Kantaro: The Sweet Tooth Salaryman", EpisodeCounts = 12,
                    Release = new DateTime(2017, 7, 14)
                },
                new Series
                {
                    Id = 10, Name = "The Walking Dead", EpisodeCounts = 177, Release = new DateTime(2010, 10, 31)
                }
            };
